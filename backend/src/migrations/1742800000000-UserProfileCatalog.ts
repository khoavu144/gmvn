...
export class UserProfileCatalog1742800000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "user_profile_terms" (
                "id" uuid NOT NULL DEFAULT gen_random_uuid(),
        ...
        await queryRunner.query(`
            CREATE TABLE "user_profile_term_selections" (
        ...
        await queryRunner.query(`
            CREATE INDEX "IDX_user_profile_terms_section" ON "user_profile_terms" ("section_id")
        `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP TABLE IF EXISTS "user_profile_term_selections"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "user_profile_terms"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "user_profile_sections"`);
    }
}
