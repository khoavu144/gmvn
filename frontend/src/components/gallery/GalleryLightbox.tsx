                    ...
                    {item.linked_user ? (
                        <div className="flex flex-col gap-4">
                            ...
                            <Link 
                                ...
                                className="mt-4 w-full py-3 bg-white text-black hover:bg-gray-200 font-bold rounded-xl text-center transition-colors flex items-center justify-center gap-2"
                            >
                                Truy cập Profile
                            </Link>
                        </div>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-400">Official Staff</p>
                                </div>
                            </div>
                        </div>
                    )}
