        ...
        <section className="bg-black py-20 md:py-32">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mb-12 md:mb-16">
                    ...
                    <p className="text-gray-500 mt-3 text-sm md:text-base">Những chuyên gia hàng đầu kiến tạo sự thay đổi</p>
                </div>
                                ...
                                >
                                    ...
                                    <div className="absolute inset-0 p-5 md:p-6 flex flex-col justify-end text-white">
                                        <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                            ...
                                            <p className="text-xs uppercase tracking-widest text-gray-500 font-medium line-clamp-1">
