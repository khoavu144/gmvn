...
const GymReviewsSection = React.memo(function GymReviewsSection({ gymId, branchId, gymTrustSummary, setRef }: Props) {
    ...
    return (
            <section ref={setRef('reviews')} id="reviews" className="gym-detail-section rounded-lg border border-black/10 bg-[linear-gradient(180deg,rgba(32,25,20,1),rgba(24,18,15,1))] p-6 text-white sm:p-8">
                <div className="mb-4 space-y-2">
                    <div className="text-[0.72rem] font-bold uppercase tracking-[0.2em] text-white/60">Đánh giá và uy tín</div>
                    <h2 className="text-xl font-bold tracking-tight text-white">Cộng đồng nói gì về nơi này</h2>
                    <p className="text-sm leading-relaxed text-white/70">
                        Tổng hợp điểm đánh giá, từng tiêu chí và phản hồi từ cơ sở để bạn hình dung rõ hơn trước buổi tập đầu tiên.
                    </p>
                </div>
