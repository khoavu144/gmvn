    ...
    return (
        <section className="py-16 sm:py-20">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
                <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[color:var(--mk-muted)] mb-3">
                    Bắt đầu hành trình
                </div>
                ...
                <p className="text-base text-[color:var(--mk-muted)] leading-relaxed max-w-md mx-auto mb-8">
