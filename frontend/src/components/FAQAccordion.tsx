            ...
            {items.map((item, i) => (
                <div key={i}>
                    <button
                        ...
                        className="w-full flex justify-between items-start gap-4 px-5 py-4 text-left hover:bg-[color:var(--mk-paper)] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-900/20 focus-visible:ring-offset-2"
