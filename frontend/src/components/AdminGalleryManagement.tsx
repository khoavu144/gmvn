                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input 
                                ...
                                placeholder="https://..."
                                className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:border-black focus:ring-1 focus:ring-black outline-none transition-colors"
                            />
                        </div>
                        <div>
                            <label className="block text-xs font-bold text-gray-700 uppercase mb-1">Caption / Trích dẫn</label>
                            <input 
                                type="text" 
                                ...
                                {items.map(item => (
                                    <tr key={item.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                        <td className="px-4 py-3">
                                            <div className="w-24 h-24 rounded-lg overflow-hidden border border-gray-200 bg-gray-100 flex items-center justify-center relative group">
                                        ...
                                        <td className="px-4 py-3">
                                            <p className="font-semibold text-gray-900 line-clamp-2">{item.caption || <span className="text-gray-400 italic">Không có trích dẫn</span>}</p>
                                        ...
                                        <td className="px-4 py-3">
                                            <div className="flex items-center gap-2">
                                                <button 
                                                    ...
                                                    className={`p-1.5 rounded-md border transition-colors ${item.is_featured ? 'border-yellow-200 bg-yellow-50 text-yellow-600' : 'border-gray-200 text-gray-400 hover:text-black hover:border-black'}`}
                                                ...
                                                <button 
                                                    ...
                                                    className="p-1.5 rounded-md border border-gray-200 text-gray-400 hover:text-red-600 hover:border-red-200 hover:bg-red-50 transition-colors"
                                                    title="Xoá"
                                                >
                ...
                {totalPages > 1 && (
                    <div className="p-4 border-t border-gray-200 bg-gray-50 flex justify-center gap-2">
                        <button 
                            ...
                            className="px-3 py-1 bg-white border border-gray-300 rounded text-xs font-bold uppercase disabled:opacity-50"
                        >
                            Trang trước
                        </button>
