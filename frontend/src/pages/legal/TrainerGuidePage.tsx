...
export default function TrainerGuidePage() {
    return (
        <LegalPageLayout
            ...
            breadcrumbs={[{ label: 'Dành cho HLV' }, { label: 'Bắt đầu làm HLV' }]}
            maxWidth="xl"
        >
            ...
            <div className="mt-8">
                ...
                <LegalSection title="Yêu cầu tối thiểu để trở thành HLV">
                    <LegalList items={[
                ...
                <LegalSection title="Quy trình xác minh HLV (Badge Verified)">
                    <div className="space-y-3">
                        {[
                            { step: '01', title: 'Đăng ký tài khoản', desc: 'Chọn loại tài khoản "Huấn luyện viên" khi đăng ký.' },
                            { step: '02', title: 'Hoàn thiện hồ sơ', desc: 'Điền đầy đủ thông tin Profile, thêm ảnh chứng chỉ vào Gallery, khai báo kinh nghiệm.' },
                            { step: '03', title: 'Gửi yêu cầu xác minh', desc: 'Liên hệ qua trang Liên hệ, chọn chủ đề "Đăng ký / xác minh HLV". Đính kèm ảnh chứng chỉ bản gốc.' },
