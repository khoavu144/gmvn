            ...
            <div className="mt-8 space-y-0">
                ...
                <LegalSection title="6. Xử lý vi phạm">
                    ...
                    <div className="space-y-3 mt-3">
                        {[
                            { level: 'Cảnh báo', color: 'border-gray-200', desc: 'Vi phạm lần đầu, mức độ nhẹ. Tài khoản không bị ảnh hưởng nhưng ghi nhận lịch sử.' },
                            { level: 'Tạm khóa 7–30 ngày', color: 'border-gray-200', desc: 'Vi phạm nghiêm trọng hoặc tái phạm. Không thể đăng ký mới / nhận học viên trong thời gian bị khóa.' },
