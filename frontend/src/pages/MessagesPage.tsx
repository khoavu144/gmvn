    ...
    return (
        <div className="page-shell-muted">
            ...
            <div className="page-container py-6 sm:py-8">
                ...
                <div className="overflow-hidden rounded-lg border border-[color:var(--mk-line)] bg-white shadow-sm md:grid md:min-h-[calc(100vh-18rem)] md:grid-cols-[20rem_minmax(0,1fr)]">
                    <div className={`border-r border-[color:var(--mk-line)] bg-[color:var(--mk-paper)] flex-col shrink-0 ${activePartner ? 'hidden md:flex' : 'flex'}`}>
                        <div className="border-b border-[color:var(--mk-line)] bg-white px-4 py-4">
                        ...
                        <div className="flex-1 overflow-y-auto">
                            {error && conversations.length === 0 ? (
                                ...
                                <div className="mt-10 p-8 text-center">
                                    ...
                                    <h3 className="mb-1 font-bold text-[color:var(--mk-text)]">Hộp thư trống</h3>
                                    <p className="mb-6 text-xs text-[color:var(--mk-muted)]">
                                    ...
                                    {conversations.map(conv => (
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border border-[color:var(--mk-line)] bg-white text-sm font-bold text-[color:var(--mk-muted)]">
                                                    {conv.partner?.full_name?.charAt(0).toUpperCase() || '?'}
                                                </div>
                                                <div className="min-w-0 flex-1">
                                                    <div className="mb-0.5 flex items-center justify-between gap-3">
                                                        <span className={`truncate text-sm ${conv.unread_count > 0 ? 'font-bold text-black' : 'font-medium text-[color:var(--mk-text)]'}`}>
                                                    ...
                                                    {conv.last_message && (
                                                        <p className={`truncate text-xs ${conv.unread_count > 0 ? 'font-medium text-black' : 'text-[color:var(--mk-muted)]'}`}>
                    ...
                    <div className={`flex-1 flex-col bg-white w-full absolute inset-0 md:static ${!activePartner ? 'hidden md:flex' : 'flex'}`}>
                        {activePartner ? (
                            <>
                                <div className="flex items-center gap-3 border-b border-[color:var(--mk-line)] bg-white px-4 py-4 sm:px-5">
                                    <button
                                        onClick={() => setActivePartner(null)}
                                        className="-ml-2 rounded-full p-1 text-[color:var(--mk-muted)] transition-colors hover:bg-[color:var(--mk-paper)] hover:text-black md:hidden"
                                    >
                                        <ChevronLeft className="h-6 w-6" />
                                    </button>
                                    <div className="flex h-9 w-9 items-center justify-center rounded-full border border-[color:var(--mk-line)] bg-[color:var(--mk-paper)] text-xs font-bold text-[color:var(--mk-text-soft)]">
                                ...
                                <div className="flex-1 overflow-y-auto bg-[color:var(--mk-paper)]/60 p-4 sm:p-6">
                                    <div className="mx-auto flex h-full w-full max-w-4xl flex-col gap-4">
                                        {loading ? (
                                            <div className="mt-4 space-y-4 animate-pulse">
                                                <div className="flex justify-start"><div className="h-10 w-48 rounded-lg rounded-tl-sm bg-[color:var(--mk-paper-strong)]"></div></div>
                                                <div className="flex justify-end"><div className="h-10 w-56 rounded-lg rounded-tr-sm bg-[color:var(--mk-paper-strong)]"></div></div>
                                                <div className="flex justify-start"><div className="h-10 w-36 rounded-lg rounded-tl-sm bg-[color:var(--mk-paper-strong)]"></div></div>
                                            </div>
                                            ...
                                            <div className="flex h-full items-center justify-center">
                                                <div className="rounded-lg border border-dashed border-[color:var(--mk-line)] bg-white px-6 py-5 text-center text-sm text-[color:var(--mk-muted)] shadow-sm">
                                                    Hãy gửi lời chào!
                                                </div>
                                            </div>
                                        ) : (
                                            messages.map(msg => {
                                                ...
                                                return (
                                                    <div key={msg.id} className={`flex ${isMe ? 'justify-end' : 'justify-start'}`}>
                                                        <div className={`max-w-[75%] rounded-lg px-4 py-2.5 text-sm shadow-sm ${isMe ? 'rounded-tr-sm bg-black text-white' : 'rounded-tl-sm border border-[color:var(--mk-line)] bg-white text-black'}`}>
                                                            {msg.content}
                                                        </div>
                                                    </div>
                                                )
                                ...
                                <div className="border-t border-[color:var(--mk-line)] bg-white p-4 sm:px-5">
                                    <div className="relative mx-auto flex max-w-4xl gap-3">
                                        <input
                                            ...
                                            className="form-input rounded-full bg-[color:var(--mk-paper)] px-5 py-3 pr-24 focus:bg-white"
                                        />
                                        <button
                                            onClick={sendMessage}
                            ...
                            <div className="hidden flex-1 items-center justify-center bg-[color:var(--mk-paper)]/50 md:flex">
                                <div className="text-center">
                                    <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full border border-[color:var(--mk-line)] bg-white text-lg font-bold text-[color:var(--mk-muted)] shadow-sm">
                                        ✉️
                                    </div>
                                    <h2 className="text-lg font-bold text-black">Chọn một cuộc trò chuyện</h2>
                                    <p className="mt-2 max-w-sm text-sm text-[color:var(--mk-muted)]">
