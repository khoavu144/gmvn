        ...
        <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black">
            ...
            <div className="relative pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden border-b border-white/10">
                ...
                <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
                    ...
                    <p className="max-w-xl mx-auto text-lg md:text-xl text-gray-400 font-medium mb-12">
            ...
            <div className="max-w-[1600px] mx-auto px-4 py-12 md:py-16">
                {items.length === 0 && !loading ? (
                    <div className="text-center py-24 border border-dashed border-white/20 rounded-3xl bg-white/5">
                        ...
                        <p className="text-gray-400">Hãy là người đầu tiên đóng góp vào thư mục này.</p>
                    </div>
                ) : (
